...
- [ x ] when linking style sheets, JavaScript, and icons for mobile apps
...
- [ x ] It identifies enclosed text as a sampler or an example.
...
- [ x ] It establishes that id is a unique identifier in the website, used for styling CSS, scripting, and linking within a webpage.
...
- [ x ] `itemprop="aggregateRating" itemref="http://schema.org/AggregateRating"`
...
- [ x ] The text displays over the audio controls, unless CSS is used to position it elsewhere.
...
- [ x ] For blog posts and other social media items
...
- [ x ] Classes allow CSS to select specific elements on the page. You may list as many class names within the class attribute as you wish,
      separated by spaces.
...
- [ x ] `<input type="text" hidden name="important" value="information">`
...
- [ x ] The form element is disabled.
